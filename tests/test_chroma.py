...
test_notes = [
    ...
    {
        "id": "note_001",
        "text": "Recorded a chord progression in D minor that feels melancholic. Might work for the bridge section.",
        "source_type": "text",
    },
    {
        "id": "note_002",
        "text": "Voice memo: the rhythm pattern I heard at the cafe - syncopated beat with a lot of space between hits.",
        "source_type": "audio_transcript",
    },
    {
        "id": "note_003",
        "text": "Thinking about how silence in music creates tension. Miles Davis used space deliberately.",
        "source_type": "text",
    },
    {
        "id": "note_004",
        "text": "The melody I hummed in the shower - starts on the fifth, drops to the third, then resolves.",
        "source_type": "text",
    },
    # Visual art / colour theme
    {
        "id": "note_005",
        "text": "The colour palette from that exhibition - deep terracotta against pale sage green. Very earthy.",
        "source_type": "text",
    },
    {
        "id": "note_006",
        "text": "Sketch idea: layered translucent shapes that create depth through overlap, like geological strata.",
        "source_type": "text",
    },
    {
        "id": "note_007",
        "text": "Image caption: photograph of morning light through curtains - diffused golden yellow, soft shadows.",
        "source_type": "image_caption",
    },
    {
        "id": "note_008",
        "text": "Thinking about negative space in composition. What you leave out defines what you keep in.",
        "source_type": "text",
    },
    # Writing / narrative theme
    {
        "id": "note_009",
        "text": "Character idea: someone who collects receipts because they fear forgetting where they have been.",
        "source_type": "text",
    },
    {
        "id": "note_010",
        "text": "The opening line I keep coming back to: she had lived in that city long enough to know which streets to avoid.",
        "source_type": "text",
    },
    {
        "id": "note_011",
        "text": "Thinking about unreliable narrators - the gap between what they say and what the reader infers.",
        "source_type": "text",
    },
    {
        "id": "note_012",
        "text": "Memory is always a reconstruction. Every time you recall something you change it slightly.",
        "source_type": "text",
    },
]
...
for i, (doc, distance, meta) in enumerate(
    zip(results_2["documents"][0], results_2["distances"][0], results_2["metadatas"][0])
):
    similarity = 1 - distance
    print(f"  Match {i+1} (similarity: {similarity:.3f}) [{meta['source_type']}]")
    print(f'  "{doc[:100]}..."' if len(doc) > 100 else f'  "{doc}"')
